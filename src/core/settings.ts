...
export const SCHEMA = {
    ...
    "air.separation": num({ group: "Air", label: "Separation slope", def: 0.18, min: 0.02, max: 2, step: 0.01, hint: "Lee slope at which the flow fully detaches, as a gradient. Measured against this terrain by scripts/checkWind.mjs, not taken from a textbook: 0.18 is the 97th percentile of downwind-descending slope, so the bubble is the steepest few percent of lee faces. Detachment begins at half of it." }),
