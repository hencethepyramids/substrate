...
export const SCHEMA = {
    ...
    "play.ridgeHeight": num({ group: "Play", label: "Ridge height", def: 0.55, min: 0.05, max: 2.5, step: 0.05, unit: "m", hint: "How tall the crest stands. Solved into a per-stamp depth from the kernel's line integral, so this is metres of crest and not an amplitude that happens to look right." }),
